...
#
# This is forked from https://github.com/jamtur01/puppet-irc. The report
# processor is the same, but the module is renamed from "irc" to the less
# generic "ircreporter", and it includes a (this) puppet class that actually
# installs and sets up the report processor on your Puppet Master.
#
# == Actions:
